...
CREATE TABLE sis_chats(
    ...
    cht_estado Varchar2(1) DEFAULT 'A' NOT NULL
        CONSTRAINT sis_chats_ck01 CHECK (cht_estado in ('A','I')),
...
ALTER TABLE sis_usuarios ADD CONSTRAINT sis_usuario_rol_fk01 FOREIGN KEY (usu_rol_id) REFERENCES sis_roles (rol_id)
;

ALTER TABLE sis_mensajes ADD CONSTRAINT sis_mensajes_usu_fk01 FOREIGN KEY (sms_usu_id) REFERENCES sis_usuarios (usu_id)
;

ALTER TABLE sis_mensajes ADD CONSTRAINT sis_mensajes_cht_fk01 FOREIGN KEY (sms_chat_id) REFERENCES sis_chats (cht_id)
;

ALTER TABLE sis_chats ADD CONSTRAINT sis_chats_usu_fk01 FOREIGN KEY (cht_usu_id) REFERENCES sis_usuarios (usu_id)
;

ALTER TABLE sis_correos ADD CONSTRAINT sis_correos_not_fk01 FOREIGN KEY (cor_not_id) REFERENCES sis_notificacion (not_id)
;
